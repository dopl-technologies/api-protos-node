...
export class CreateCatheterPathRequest extends jspb.Message { 
    ...
    setPath(value?: CatheterPath): CreateCatheterPathRequest;
...
export class CreateCatheterPathResponse extends jspb.Message { 
    getId(): number;
    setId(value: number): CreateCatheterPathResponse;
...
export class GetCatheterPathRequest extends jspb.Message { 
    getId(): number;
    setId(value: number): GetCatheterPathRequest;
...
export class GetCatheterPathResponse extends jspb.Message { 
    ...
    clearPath(): void;
    getPath(): CatheterPath | undefined;
    setPath(value?: CatheterPath): GetCatheterPathResponse;
...
export class GetCoordinatesCatheterPathRequest extends jspb.Message { 
    getId(): number;
    setId(value: number): GetCoordinatesCatheterPathRequest;
...
export class GetCoordinatesCatheterPathResponse extends jspb.Message { 
    ...
    setCoordinate(value?: common_pb.CatheterCoordinates): GetCoordinatesCatheterPathResponse;
...
export class ListCatheterPathsResponse extends jspb.Message { 
    ...
    clearPath(): void;
    getPath(): CatheterPath | undefined;
    setPath(value?: CatheterPath): ListCatheterPathsResponse;
...
export class CatheterPath extends jspb.Message { 
    getId(): number;
    setId(value: number): CatheterPath;
    getStartcatheterdataid(): number;
    setStartcatheterdataid(value: number): CatheterPath;
    getEndcatheterdataid(): number;
    setEndcatheterdataid(value: number): CatheterPath;
    getName(): string;
    setName(value: string): CatheterPath;

    hasCreated(): boolean;
    clearCreated(): void;
    getCreated(): google_protobuf_timestamp_pb.Timestamp | undefined;
    setCreated(value?: google_protobuf_timestamp_pb.Timestamp): CatheterPath;
